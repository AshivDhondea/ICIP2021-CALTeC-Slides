...
\subtitle{ICIP 2021. Paper ID: 3013} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\smallskip
\centering
\includegraphics[scale=0.37]{SFUhorizontallogorgb.pdf}
}
...
\begin{frame}
	...
	\begin{figure}
		\begin{minipage}{.45\textwidth}
			\includegraphics[width=0.78\linewidth]{tensorviz4.pdf}
